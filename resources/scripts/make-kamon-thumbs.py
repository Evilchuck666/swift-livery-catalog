#!/usr/bin/env python3
"""
Genera miniaturas WebP 360x360 con fondo blanco para los PNG de resources/kamon/PNG/.

Uso:  python3 make-kamon-thumbs.py           # solo procesa los que faltan
      python3 make-kamon-thumbs.py --force   # regenera todos
"""
...
PNG_DIR      = SCRIPT_DIR / "resources" / "kamon" / "PNG"
THUMBS_DIR   = SCRIPT_DIR / "resources" / "kamon" / "thumbnails"
THUMB_SIZE   = (360, 360)
WEBP_QUALITY = 85
WEBP_METHOD  = 6
